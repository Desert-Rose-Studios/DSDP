    ...
    if renpy.get_screen("main_menu"):
        ...
        vbox:
            ...
            if main_menu:
                ...
                textbutton _("Historial") action ShowMenu("history")
                textbutton _("Guardar") action ShowMenu("save")
            textbutton _("Cargar") action ShowMenu("loSad")
...
screen main_menu():
    ...
    imagebutton auto "menuUI/patreon_%s.png":
        action OpenURL(" ")
        at patreonbutton
    imagebutton:
        auto ("menuUI/new_game_%s.png")
        action Start()
        at startbutton
    imagebutton:
        auto ("menuUI/load_game_%s.png")
